...
class CustomClearableFileInput(ClearableFileInput):
    ...
    Extends Django's ClearableFileInput to
    customise the appearance and behavior.
    """
    ...
    template_name = 'products/custom_widget_templates/custom_clearable_file_input.html'  # noqa: E501 (Fix flake 8 line too long)
